...
export function PlaneIcon({ className = '', size = 'md' }: IconProps) {
  return (
    <svg
...
export function CloseIcon({ className = '', size = 'md' }: IconProps) {
  return (
    <svg
      className={`${sizeClasses[size]} ${className}`}
      fill="none"
...
export function FilterIcon({ className = '', size = 'md' }: IconProps) {
  return (
    <svg
      className={`${sizeClasses[size]} ${className}`}
      fill="none"
...
export function SwapIcon({ className = '', size = 'md' }: IconProps) {
  return (
    <svg
      className={`${sizeClasses[size]} ${className}`}
      fill="none"
...
export function SadFaceIcon({ className = '', size = 'md' }: IconProps) {
  return (
    <svg
      className={`${sizeClasses[size]} ${className}`}
      fill="none"
...
export function HistoryIcon({ className = '', size = 'md' }: IconProps) {
  return (
    <svg
      className={`${sizeClasses[size]} ${className}`}
      fill="none"
